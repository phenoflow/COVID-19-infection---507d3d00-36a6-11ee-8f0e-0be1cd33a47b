...
(async () => {
  ...
  await fs.writeFile("covid-19-infection-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("covid-19-infection-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
